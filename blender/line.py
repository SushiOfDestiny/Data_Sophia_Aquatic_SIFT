...
def check_ray_intersect(obj, pt_world_1, pt_world_2, cam_1, cam_2, epsilon):
    ...
    result_1, vec_1 = obj.ray_cast(cam_1.location, pt_world_1 - cam_1.location)
    result_2, vec_2 = obj.ray_cast(cam_2.location, pt_world_2 - cam_2.location)
...
def check_correct_match(objs, x1, y1, x2, y2, cam_1, cam_2, epsilon):
    ...
    for obj in objs:
        r, vec = check_ray_intersect(obj, x1, y1, x2, y2, cam_1, cam_2, epsilon)
        if r:
            return (r, vec)

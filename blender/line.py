...
def check_correct_match_pt_variable_epsilon(objs, x1, y1, x2, y2, x1_shift, y1_shift, x2_shift, y2_shift, cam_1, cam_2):
    ...
    for obj in objs:
        ...
        result_1_1px_shift, vec_1_1px_shift, _, _ = obj.ray_cast(cam_1.location, pt_world_1_1px_shift - cam_1.location)
        draw_points([vec_1_1px_shift], "pt_1_shift")
        result_2_1px_shift, vec_2_1px_shift, _, _ = obj.ray_cast(cam_2.location, pt_world_2_1px_shift - cam_2.location)

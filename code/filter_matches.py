...
# add script folder to path, path corresponding to location of the virtual scsene blender file
...
if __name__ == "__main__":
    ...
    kp_pairs_file = f"{storage_folder}/{filename_preffix}_kp_pairs.npy"
    ...
    correct_matches_idxs_filename = f"{storage_folder}/{filename_preffix}_idxs"
